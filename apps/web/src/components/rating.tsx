export const Rating = () => {
	return (
		<>
			<figure
				className="laurels_badge-module__14iIVa__laurelsBadge"
				aria-label="App rating badge showing rating 5.0">
				<div className="laurels_badge-module__14iIVa__header">
					<div
						className="rating_laurels_badge-module__Qibjea__stars"
						aria-hidden="true">
						<div className="star_rating-module__RrnvQG__starRating">
							<span
								className="material-symbols-rounded icon-module__wVyUta__icon icon-module__wVyUta__iconFilled "
								style={{ fontSize: "11px" }}>
								star
							</span>
							<span
				...
				<div className="laurels_badge-module__14iIVa__laurelsWrap">
					<div className="laurels_badge-module__14iIVa__laurelLeading">
						<svg
				...
				<div className="laurels_badge-module__14iIVa__caption">
					worldwide rating
				</div>
			</figure>
		</>
