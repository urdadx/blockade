...
function getColumns({
  ...
  return [
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-2.5 font-medium">
          <img
            ...
            loading="lazy"
            decoding="async"
            className="size-6 rounded outline outline-1 -outline-offset-1 outline-black/10 dark:outline-white/10"
          />
    ...
    },
    {
      ...
      size: 280,
      cell: ({ row }) => (
        <UsageLimit dailyLimit={row.original.dailyLimit} usedMinutes={row.original.usedMinutes} />
      ),
    },
    {
      id: "actions",
...
export function BlockListTable() {
  ...
  return (
    <CardFrame className="w-full max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border bg-card md:max-w-full">
