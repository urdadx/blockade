...
export function LogoutLinear(props: SVGProps<SVGSVGElement>) {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" {...props}>
      ...
      <g fill="none" stroke={color} strokeWidth="1.5">
        ...
        />
        <path d="M8 19.5c-2.357 0-3.536 0-4.268-.732C3 18.035 3 16.857 3 14.5v-5c0-2.357 0-3.536.732-4.268S5.643 4.5 8 4.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15 12H6m0 0l2 2m-2-2l2-2" />
      </g>
    </svg>
  );
}
